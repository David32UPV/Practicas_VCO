...
# Escalar la imagen (fx y fy son los factores de escala vertical y horizontal)
image_scaled = cv2.resize(src, None, fx=2.0, fy=2.0, interpolation=cv2.INTER_LINEAR)
...
cv2.imshow('Imagen escalada', image_scaled)
